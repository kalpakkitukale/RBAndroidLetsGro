        ...
        viewModel.apply {
            ...
            shareLiveData.observe(this@CoursesFragment, Observer {
                it?.let{
                    ...
                    val link:String=  "details?id=" + BuildConfig.APPLICATION_ID+"&http://www.letsgro.in/course&url=&referrer="+it.courseId+","+data+"#Intent;scheme=market;action=android.intent.action.VIEW;package=com.android.vending;end\""
