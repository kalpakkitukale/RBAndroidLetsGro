...
class RoundedImageView @JvmOverloads constructor(
    ...
    private fun init(context: Context, attrs: AttributeSet?, defStyleAttr: Int) {
        ...
        circleColor =
            attributes.getColor(R.styleable.RoundedImageView_civ_circle_color, Color.WHITE)
        ...
        if (attributes.getBoolean(R.styleable.RoundedImageView_civ_border, true)) {
            ...
            borderWidth = attributes.getDimension(
                R.styleable.RoundedImageView_civ_border_width,
                defaultBorderSize
            )
            borderColor =
                attributes.getColor(R.styleable.RoundedImageView_civ_border_color, Color.WHITE)
        }

        // Init Shadow
        shadowEnable =
            attributes.getBoolean(R.styleable.RoundedImageView_civ_shadow, shadowEnable)
        if (shadowEnable) {
            shadowGravity = attributes.getInteger(
                R.styleable.RoundedImageView_civ_shadow_gravity,
                shadowGravity.value
            ).toShadowGravity()
            shadowRadius = attributes.getFloat(
                R.styleable.RoundedImageView_civ_shadow_radius,
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        // Draw Circle pattern_background_repeat
        canvas.drawCircle(
            circleCenterWithBorder,
            circleCenterWithBorder,
